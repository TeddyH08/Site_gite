		...
		jQuery(window).on('scroll', function () {
			...
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.header-intera .container > .logo-header .logo').attr('src','images/logo.png');

				} else {

					menu.removeClass('is-fixed');

					$('.header-intera .container > .logo-header .logo').attr('src','images/logo-white.png')
